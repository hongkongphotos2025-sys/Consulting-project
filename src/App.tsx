...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Initial fetch
    getLiveMarketData().then(setMarketData);
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-text/50">
              ...
              <li className="hover:text-accent transition-colors cursor-pointer font-bold text-accent"><a href="/source.zip" download="survvi-opulence-insights-source.zip">Download Source Code</a></li>
            </ul>
          </div>
        </div>
